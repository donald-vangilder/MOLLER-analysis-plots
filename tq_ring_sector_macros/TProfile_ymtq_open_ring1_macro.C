void TProfile_ymtq_open_ring1_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("yield_tq%02d_r1", 4*i+3);
    ...
    TProfile* h = new TProfile("ring1o", "Ring 1 Open Segments;Detector Number;Yield", 9, -0.5, 8.5, ymin, ymax);
