void ymtq_all_ring4_macro() {
    ...
    for (int i = 0; i < 28; ++i) {
        detNames[i] = Form("yield_tq%02d_r4", i+1);
    ...
    TH2F* h = new TH2F("ring4a", "All Ring 4 Segments;Detector Number;Yield", 30, -0.5, 29.5, 1000, ymin, ymax);
