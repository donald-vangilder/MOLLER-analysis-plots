void TProfile_ymtq_open_ring4_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("yield_tq%02d_r4", 4*i+3);
    ...
    TProfile* h = new TProfile("ring4o", "Ring 4 Open Segments;Detector Number;Yield", 9, -0.5, 8.5, ymin, ymax);
