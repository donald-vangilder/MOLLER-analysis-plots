void TProfile_etq_ring5_macro() {
    ...
    TProfile* p = new TProfile("r5", "All Ring 5 Segments; ;Yield", 88, -2.5, 85.5, ymin, ymax);
    ...
    for (int k=0; k<28; k++) {
        p->GetXaxis()->SetBinLabel(3*k+4, segments[k].c_str());
	p->GetXaxis()->SetLabelSize(0.02);
    }
