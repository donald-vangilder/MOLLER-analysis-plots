void TProfile_amtq_closed_ring4_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("asym_tq%02d_r4", 4*i+1);
    ...
    TProfile* h = new TProfile("ring4c", "Ring 4 Closed Segments;Detector Number;Asymmetry", 9, -0.5, 8.5, ymin, ymax);
