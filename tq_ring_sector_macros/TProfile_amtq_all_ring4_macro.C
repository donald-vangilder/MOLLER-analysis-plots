void TProfile_amtq_all_ring4_macro() {
    TTree* tree = (TTree*)gROOT->FindObject("mul");
    Long64_t nEntries = tree->GetEntries();
    tree->SetBranchStatus("*", false);

    std::cout << "All Ring 4 Segments" << std::endl;
    ...
    TProfile* h = new TProfile("ring4a", "All Ring 4 Segments;Detector Number;Asymmetry", 30, -0.5, 29.5, ymin, ymax);
