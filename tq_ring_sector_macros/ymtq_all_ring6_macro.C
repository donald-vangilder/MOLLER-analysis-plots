void ymtq_all_ring6_macro() {
    ...
    for (int i = 0; i < 28; ++i) {
        detNames[i] = Form("yield_tq%02d_r6", i+1);
    ...
    TH2F* h = new TH2F("ring6a", "All Ring 6 Segments;Detector Number;Yield", 30, -0.5, 29.5, 1000, ymin, ymax);
