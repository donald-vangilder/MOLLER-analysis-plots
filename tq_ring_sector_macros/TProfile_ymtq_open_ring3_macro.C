void TProfile_ymtq_open_ring3_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("yield_tq%02d_r3", 4*i+3);
    ...
    TProfile* h = new TProfile("ring3o", "Ring 3 Open Segments;Detector Number;Yield", 9, -0.5, 8.5, ymin, ymax);
