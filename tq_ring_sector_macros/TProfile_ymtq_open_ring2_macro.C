void TProfile_ymtq_open_ring2_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("yield_tq%02d_r2", 4*i+3);
    ...
    TProfile* h = new TProfile("ring2o", "Ring 2 Open Segments;Detector Number;Yield", 9, -0.5, 8.5, ymin, ymax);
