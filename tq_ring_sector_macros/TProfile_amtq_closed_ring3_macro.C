void TProfile_amtq_closed_ring3_macro() {
    ...
    for (int i = 0; i < 7; ++i) {
        detNames[i] = Form("asym_tq%02d_r3", 4*i+1);
    ...
    TProfile* h = new TProfile("ring3c", "Ring 3 Closed Segments;Detector Number;Asymmetry", 9, -0.5, 8.5, ymin, ymax);
