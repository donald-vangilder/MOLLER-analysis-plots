void TProfile_ymtq_trans_ring1_macro() {
    ...
    for (int i = 0; i < 14; ++i) {
        detNames[i] = Form("yield_tq%02d_r1", 2*i+2);
    ...
    TProfile* h = new TProfile("ring1t", "Ring 1 Transition Segments;Detector Number;Yield", 16, -0.5, 15.5, ymin, ymax);
