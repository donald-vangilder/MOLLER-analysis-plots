void TProfile_amtq_trans_ring1_macro() {
    ...
    for (int i = 0; i < 14; ++i) {
        detNames[i] = Form("asym_tq%02d_r1", 2*i+2);
    ...
    TProfile* h = new TProfile("ring1t", "Ring 1 Transition Segments;Detector Number;Asymmetry", 16, -0.5, 15.5, ymin, ymax);
