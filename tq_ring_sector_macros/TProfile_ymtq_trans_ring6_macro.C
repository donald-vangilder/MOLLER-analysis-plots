void TProfile_ymtq_trans_ring6_macro() {
    ...
    for (int i = 0; i < 14; ++i) {
        detNames[i] = Form("yield_tq%02d_r6", 2*i+2);
    ...
    TProfile* h = new TProfile("ring6t", "Ring 6 Transition Segments;Detector Number;Yield", 16, -0.5, 15.5, ymin, ymax);
