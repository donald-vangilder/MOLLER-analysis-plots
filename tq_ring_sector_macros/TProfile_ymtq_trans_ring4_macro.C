void TProfile_ymtq_trans_ring4_macro() {
    ...
    for (int i = 0; i < 14; ++i) {
        detNames[i] = Form("yield_tq%02d_r4", 2*i+2);
    ...
    TProfile* h = new TProfile("ring4t", "Ring 4 Transition Segments;Detector Number;Yield", 16, -0.5, 15.5, ymin, ymax);
