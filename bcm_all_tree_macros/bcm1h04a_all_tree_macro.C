void bcm1h04a_all_tree_macro() {
        std::cout << "---------------------------------------" << endl;
        std::cout << "BCM 1h04a" << endl;
...
// evt tree
	...
	tree1->SetBranchStatus("bcm1h04a", true);
        TBranch* br_evt = tree1->GetBranch("bcm1h04a");
	...
	std::cout << "bcm1h04a:  Min = " << vmin_evt << ", Max = " << vmax_evt << std::endl;
	...
	tree1->Draw("bcm1h04a.hw_sum>>h1_bcm1h04a(100,ymin_evt,ymax_evt)", "", "goff");
	TH1F* h1_bcm1h04a = (TH1F*)gDirectory->Get("h1_bcm1h04a");
	h1_bcm1h04a->SetTitle("Overlayed bcm1h04a tree yields;Yield;Counts");
        h1_bcm1h04a->SetLineColor(kBlue);
        h1_bcm1h04a->SetStats(false);
        h1_bcm1h04a->Draw("HIST");
...
// pr tree
        ...
        tree2->SetBranchStatus("yield_bcm1h04a", true);
        TBranch* br_pr = tree2->GetBranch("yield_bcm1h04a");
        ...
        std::cout << "bcm1h04a:  Min = " << vmin_pr << ", Max = " << vmax_pr << std::endl;
        ...
        tree2->Draw("yield_bcm1h04a.hw_sum>>h2_bcm1h04a(100,ymin_pr,ymax_pr)", "", "goff");
        TH1F* h2_bcm1h04a = (TH1F*)gDirectory->Get("h2_bcm1h04a");
        h2_bcm1h04a->Scale(2);
        h2_bcm1h04a->SetLineColor(kRed);
        h2_bcm1h04a->SetStats(false);
        h2_bcm1h04a->Draw("HIST SAME");
...
// mul tree
        ...
        tree3->SetBranchStatus("yield_bcm1h04a", true);
        TBranch* br_mul = tree3->GetBranch("yield_bcm1h04a");
        ...
        std::cout << "bcm1h04a:  Min = " << vmin_mul << ", Max = " << vmax_mul << std::endl;
        ...
        tree3->Draw("yield_bcm1h04a.hw_sum>>h3_bcm1h04a(100,ymin_mul,ymax_mul)", "", "goff");
        TH1F* h3_bcm1h04a = (TH1F*)gDirectory->Get("h3_bcm1h04a");
	h3_bcm1h04a->Scale(64);
	h3_bcm1h04a->SetLineColor(kGreen);
        h3_bcm1h04a->SetStats(false);
        h3_bcm1h04a->Draw("HIST SAME");


// legend
	TLegend* l = new TLegend(0.7, 0.7, 0.9, 0.9);
	l->AddEntry(h1_bcm1h04a, "evt tree", "l");
        l->AddEntry(h2_bcm1h04a, "pr tree x2", "l");
        l->AddEntry(h3_bcm1h04a, "mul tree x64", "l");
	l->Draw();
}
