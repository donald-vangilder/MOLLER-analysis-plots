void bcm1h13_all_tree_macro() {
        std::cout << "---------------------------------------" << endl;
        std::cout << "BCM 1h13" << endl;
...
// evt tree
	...
	tree1->SetBranchStatus("bcm1h13", true);
        TBranch* br_evt = tree1->GetBranch("bcm1h13");
	...
	std::cout << "bcm1h13:   Min = " << vmin_evt << ", Max = " << vmax_evt << std::endl;
	...
	tree1->Draw("bcm1h13.hw_sum>>h1_bcm1h13(100,ymin_evt,ymax_evt)", "", "goff");
	TH1F* h1_bcm1h13 = (TH1F*)gDirectory->Get("h1_bcm1h13");
	h1_bcm1h13->SetTitle("Overlayed bcm1h13 tree yields;Yield;Counts");
        h1_bcm1h13->SetLineColor(kBlue);
        h1_bcm1h13->SetStats(false);
        h1_bcm1h13->Draw("HIST");
...
// pr tree
        ...
        tree2->SetBranchStatus("yield_bcm1h13", true);
        TBranch* br_pr = tree2->GetBranch("yield_bcm1h13");
        ...
        std::cout << "bcm1h13:   Min = " << vmin_pr << ", Max = " << vmax_pr << std::endl;
        ...
        tree2->Draw("yield_bcm1h13.hw_sum>>h2_bcm1h13(100,ymin_pr,ymax_pr)", "", "goff");
        TH1F* h2_bcm1h13 = (TH1F*)gDirectory->Get("h2_bcm1h13");
        h2_bcm1h13->Scale(2);
        h2_bcm1h13->SetLineColor(kRed);
        h2_bcm1h13->SetStats(false);
        h2_bcm1h13->Draw("HIST SAME");
...
// mul tree
        ...
        tree3->SetBranchStatus("yield_bcm1h13", true);
        TBranch* br_mul = tree3->GetBranch("yield_bcm1h13");
        ...
        std::cout << "bcm1h13:   Min = " << vmin_mul << ", Max = " << vmax_mul << std::endl;
        ...
        tree3->Draw("yield_bcm1h13.hw_sum>>h3_bcm1h13(100,ymin_mul,ymax_mul)", "", "goff");
        TH1F* h3_bcm1h13 = (TH1F*)gDirectory->Get("h3_bcm1h13");
	h3_bcm1h13->Scale(64);
	h3_bcm1h13->SetLineColor(kGreen);
        h3_bcm1h13->SetStats(false);
        h3_bcm1h13->Draw("HIST SAME");


// legend
	TLegend* l = new TLegend(0.7, 0.7, 0.9, 0.9);
	l->AddEntry(h1_bcm1h13, "evt tree", "l");
        l->AddEntry(h2_bcm1h13, "pr tree x2", "l");
        l->AddEntry(h3_bcm1h13, "mul tree x64", "l");
	l->Draw();
}
