void bcm1h12b_all_tree_macro() {
        std::cout << "---------------------------------------" << endl;
        std::cout << "BCM 1h12b" << endl;
...
// evt tree
	...
	tree1->SetBranchStatus("bcm1h12b", true);
        TBranch* br_evt = tree1->GetBranch("bcm1h12b");
	...
	std::cout << "bcm1h12b:  Min = " << vmin_evt << ", Max = " << vmax_evt << std::endl;
	...
	tree1->Draw("bcm1h12b.hw_sum>>h1_bcm1h12b(100,ymin_evt,ymax_evt)", "", "goff");
	TH1F* h1_bcm1h12b = (TH1F*)gDirectory->Get("h1_bcm1h12b");
	h1_bcm1h12b->SetTitle("Overlayed bcm1h12b tree yields;Yield;Counts");
        h1_bcm1h12b->SetLineColor(kBlue);
        h1_bcm1h12b->SetStats(false);
        h1_bcm1h12b->Draw("HIST");
...
// pr tree
        ...
        tree2->SetBranchStatus("yield_bcm1h12b", true);
        TBranch* br_pr = tree2->GetBranch("yield_bcm1h12b");
        ...
        std::cout << "bcm1h12b:  Min = " << vmin_pr << ", Max = " << vmax_pr << std::endl;
        ...
        tree2->Draw("yield_bcm1h12b.hw_sum>>h2_bcm1h12b(100,ymin_pr,ymax_pr)", "", "goff");
        TH1F* h2_bcm1h12b = (TH1F*)gDirectory->Get("h2_bcm1h12b");
        h2_bcm1h12b->Scale(2);
        h2_bcm1h12b->SetLineColor(kRed);
        h2_bcm1h12b->SetStats(false);
        h2_bcm1h12b->Draw("HIST SAME");
...
// mul tree
        ...
        tree3->SetBranchStatus("yield_bcm1h12b", true);
        TBranch* br_mul = tree3->GetBranch("yield_bcm1h12b");
        ...
        std::cout << "bcm1h12b:  Min = " << vmin_mul << ", Max = " << vmax_mul << std::endl;
        ...
        tree3->Draw("yield_bcm1h12b.hw_sum>>h3_bcm1h12b(100,ymin_mul,ymax_mul)", "", "goff");
        TH1F* h3_bcm1h12b = (TH1F*)gDirectory->Get("h3_bcm1h12b");
	h3_bcm1h12b->Scale(64);
	h3_bcm1h12b->SetLineColor(kGreen);
        h3_bcm1h12b->SetStats(false);
        h3_bcm1h12b->Draw("HIST SAME");


// legend
	TLegend* l = new TLegend(0.7, 0.7, 0.9, 0.9);
	l->AddEntry(h1_bcm1h12b, "evt tree", "l");
        l->AddEntry(h2_bcm1h12b, "pr tree x2", "l");
        l->AddEntry(h3_bcm1h12b, "mul tree x64", "l");
	l->Draw();
}
