void tqr4_mean_macro() {
	...
	Long64_t nEntries = tree->GetEntries();
        ...
        for (int i=0; i<28; ++i) {
                detNames[i] = Form("asym_tq%02d_r4", i+1);
        ...
        for (int i=0; i<28; ++i) {
                TString branch = Form("asym_tq%02d_r4", i+1);
                TString histname = Form("htq%02d_r4", i+1);
	...
	TH2F* h = new TH2F("r4m", "Thin Quartz Ring 4 Mean Asymmetries vs Segment;Segment Number;Mean Asymmetry", 30, -0.5, 29.5, 1000, ymin, ymax);
